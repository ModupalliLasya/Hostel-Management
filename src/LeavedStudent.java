...
public class LeavedStudent extends javax.swing.JFrame {
    ...
    public LeavedStudent() {
        ...
        try{
           ...
           while(rs.next()){
                model.addRow(new Object[]{rs.getString(2),rs.getString(6),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(10),rs.getString(7),rs.getString(1),rs.getString(8)});
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(626, 20, 60, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Mobile Number", "Father Name", "Mother Name", "Email", "Address", "College Name", "Student Id", "Room Number"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 67, 672, 420));
