...
public class LeavedEmployee extends javax.swing.JFrame {
    ...
    public LeavedEmployee() {
        ...
        try{
            ...
            ResultSet rs=stm.executeQuery("select * from employee where status='Not Working'");
            while(rs.next()){
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Employee Id", "Father Name", "Mother Name", "Email", "Address", "Mobile Number", "Designation"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 55, 688, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(645, 6, 49, -1));
