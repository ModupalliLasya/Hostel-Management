...
public class AllEmployeeWorking extends javax.swing.JFrame {
    ...
    public AllEmployeeWorking() {
        ...
        try{
            ...
            ResultSet rs=stm.executeQuery("select * from employee where status='Working'");
            while(rs.next()){
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(647, 6, 47, -1));
